...
define
    Exists(val) == val /= NULL
    RequestingClients ==
        {c \in Clients: Exists(query[c])
            /\ query[c].type = "request"}
end define;
...
\* BEGIN TRANSLATION (chksum(pcal) = "96766c1a" /\ chksum(tla) = "813bf553")
...
\* Last modified Sat Nov 20 20:48:39 JST 2021 by yoshitsugu
\* Created Sat Nov 20 20:21:21 JST 2021 by yoshitsugu
